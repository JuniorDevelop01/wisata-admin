...
<html>
	...
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="dist/css/css/magnific-popup.css">

	<!-- Flexslider  -->
	<link rel="stylesheet" href="dist/css/css/flexslider.css">
			...
			<div class="row">
				<div class="col-md-8">
					<a href="images/portfolio-1.jpg" class="image-popup img-portfolio-detail">
						<img src="assets/image/Masjid/Masjid Babut Taqwa Ie Meulee.jpg" alt="Free HTML5 Template by FreeHTML5.co" class="img-responsive">
					</a>
				
				</div>
				<div class="col-md-4 fh5co-project-detail">
					<h2 class="fh5co-project-title">Masjid</h2>
					<span class="fh5co-project-sub">Banda Aceh</span>
